...
from .views import agregar_al_carrito, ver_carrito, mis_pedidos, ver_perfil, ver_pedidos_admin, detalle_pedido_admin, gestionar_soporte, detalle_soporte_admin, mis_seguimientos
from .views import detalle_seguimiento, seguimiento_admin, detalle_seguimiento_admin, desbloquear_usuario, bloquear_usuario
...
urlpatterns = [
    ...
    path('adm/pedidos', ver_pedidos_admin, name='ver_pedidos_admin'),
    path('adm/pedido/<int:pedido_id>/', detalle_pedido_admin, name='detalle_pedido_admin'),
    path('adm/soporte/', gestionar_soporte, name='gestionar_soporte'),
    path('adm/soporte/<int:mensaje_id>/', detalle_soporte_admin, name='detalle_soporte_admin'),
    path('seguimiento/', mis_seguimientos, name='mis_seguimientos'),
    path('seguimiento/<int:seguimiento_id>/', detalle_seguimiento, name='detalle_seguimiento'),
